...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        // //
         ...
         $pageset = PageSetting::findOrFail(1);
         return view('admin.settings', compact('setting','pageset'));
    }
    ...
    {
        $homesections = PageSetting::findOrFail(1);
    ...
    {
        $color = Setting::findOrFail(1)->theme_color;
    ...
    public function setlanguage()
    {
        ...
        $languageList = Language::where('status', '=', 'ok')->get();
        return view('admin.language', ['languageList' => $languageList]);
    }
